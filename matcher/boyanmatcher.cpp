...
{
	auto logger_ = spdlog::stdout_color_mt("boyan_template_matching");  //spdlog::rotating_logger_mt<spdlog::async_factory>("file_logger", "run.log", 1024 * 1024 * 5, 1);
