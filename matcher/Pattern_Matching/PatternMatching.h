...
#include "boyan_template_matching.h"
#include <ctime>
#include <assert.h>
#include <numeric>
#include <vector>
...
namespace boyan_template_matching
{
	...
	{
	public:
		PatternMatcher(const MatcherParam& param);
		~PatternMatcher();
		virtual int match(const cv::Mat & frame, std::vector<MatchResult> &matchResults) override;
